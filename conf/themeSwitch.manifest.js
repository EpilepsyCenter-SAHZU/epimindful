...
export const THEME_SWITCH_MANIFEST = {
  ...
  hexo: {
    ...
    palette: [
      { key: 'HEXO_COLOR_PRIMARY', cssVar: '--hexo-color-primary-light', label: '主色', defaultValue: '#4f627c' },
      ...
      { key: 'HEXO_COLOR_PRIMARY_DARK', cssVar: '--hexo-color-primary-dark', label: '深色模式：主色', defaultValue: '#8899aa' },
